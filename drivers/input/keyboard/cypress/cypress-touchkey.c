...
#ifdef LED_LDO_WITH_REGULATOR
static DEVICE_ATTR(led_fadein, S_IRUGO | S_IWUSR | S_IWGRP, get_touchkey_fadein,
		set_touchkey_fadein);
static DEVICE_ATTR(led_fadeout, S_IRUGO | S_IWUSR | S_IWGRP, get_touchkey_fadeout,
		set_touchkey_fadeout);
#endif
static DEVICE_ATTR(led_on_touch, S_IRUGO | S_IWUGO, led_on_touch_read, led_on_touch_write);

//xstatic DEVICE_ATTR(blnww, S_IRUGO | S_IWUGO, blnww_status_read,  blnww_status_write);

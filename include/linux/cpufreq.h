...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_CONSERVACTIVE)
extern struct cpufreq_governor cpufreq_gov_conservactive;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_conservactive)
